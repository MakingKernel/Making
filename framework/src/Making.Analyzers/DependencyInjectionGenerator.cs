...
namespace Making.Analyzers
{
    ...
    public sealed class DependencyInjectionGenerator : IIncrementalGenerator
    {
        ...
        private static Dictionary<string, INamedTypeSymbol> GetAttributeSymbols(Compilation compilation)
        {
            ...
            {
                var symbol = compilation.GetTypeByMetadataName($"Making.{attrName}");
            ...
            ImmutableArray<AttributeData> attributes)
        {
            foreach (var attr in attributes)
            {
                ...
                // Only check attributes from Making namespace
                if (attrNamespace != "Making")
                    continue;
            ...
            ImmutableArray<AttributeData> attributes)
        {
            foreach (var attr in attributes)
            {
                ...
                // Only process attributes from Making namespace
                if (attrNamespace != "Making")
                    continue;
        ...
        private static void GenerateMainExtensionsFile(SourceProductionContext context, List<ServiceInfo> services, string projectName)
        {
            ...
            sb.AppendLine("// This code was generated by Making.DependencyInjectionGenerator");
            ...
            sb.AppendLine();
            sb.AppendLine("namespace Making");
            sb.AppendLine("{");
