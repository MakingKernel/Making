...
namespace Mark.MiniApis.Analyzers
{
    ...
    public class MiniApiGenerator : IIncrementalGenerator
    {
            ...
            ImmutableArray<ClassInfo?> classes)
        {
            ...
            if (!classInfos.Any())
            {
                ...
                context.AddSource("MiniApiExtensions.Debug.g.cs", SourceText.From(debugBuilder.ToString(), Encoding.UTF8));
                return;
            }
        ...
        private void GenerateMainExtensionsFile(SourceProductionContext context, List<ClassInfo> classInfos)
        {
            ...
            sourceBuilder.AppendLine("// This code was generated by Mark MiniApi Source Generator");
            ...
            sourceBuilder.AppendLine("        public static WebApplication MapMiniApis(this WebApplication webApplication)");
            sourceBuilder.AppendLine("        {");
            ...
            Compilation compilation, CancellationToken cancellationToken)
        {
            ...
            var sourceBuilder = new StringBuilder();
            sourceBuilder.AppendLine("// <auto-generated />");
            sourceBuilder.AppendLine($"// This code was generated by Mark MiniApi Source Generator for {classInfo.ClassName}");
            sourceBuilder.AppendLine("#nullable enable");
            sourceBuilder.AppendLine();
            sourceBuilder.AppendLine("using Microsoft.AspNetCore.Builder;");
            sourceBuilder.AppendLine("using Microsoft.Extensions.DependencyInjection;");
            ...
            sourceBuilder.AppendLine($"            var {instanceName} = webApplication.MapGroup(\"{classInfo.Route}\"){GenerateClassAttributes(classInfo)};");
